...
var mongoDB =
  "mongodb+srv://test_admin:admin123@cluster0.j1opjhi.mongodb.net/webapp?retryWrites=true&w=majority";
// var mongoDB = 'mongodb://127.0.0.1/sms';

mongoose.connect(mongoDB, { useNewUrlParser: true, useUnifiedTopology: true });

const db = mongoose.connection;
db.on("error", console.error.bind(console, "Mongo cloud connection error: "));
